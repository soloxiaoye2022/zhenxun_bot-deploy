...
Set_pip_Mirror() {
  ...
  [[ ${mirror_num} == 4 ]] && mirror_url='"http://pypi.douban.com/simple/"'
  [[ ${mirror_num} == 5 ]] && mirror_url='"https://pypi.mirrors.ustc.edu.cn/simple/"'
...
Set_dependency() {
    ...
    poetry run ${python_v} -m pip install nonebot-adapter-onebot
}
